...
const getDisplaySlotCode = (slotCode) => {
  return String(slotCode || "")
    .replace("-BIKE-", "-MOTORBIKE-")
    .replace("-BIKE", "-MOTORBIKE");
};
...
const ParkingManagement = () => {
  ...
  const canManageSlots = ["SYSTEM_ADMIN", "PARKING_MANAGER"].includes(currentRole);
        ...
        >
          ...
          >
            <div style={{ minWidth: 0 }}>
              ...
              >
                {getDisplaySlotCode(slot.slotCode)}
              </h4>
