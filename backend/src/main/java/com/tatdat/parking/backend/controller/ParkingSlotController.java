...
public class ParkingSlotController {
    ...
    getSlotById(@PathVariable Integer id) {
    ...
    deleteSlot(@PathVariable Integer id) {
    ...
    updateSlotStatus(
        ...
        return ResponseEntity.ok(
                parkingSlotService.updateStatus(
                        id,
                        request.getStatus()
                )
        );
    ...
    countAvailableSlots() {
        ...
        return ResponseEntity.ok(
                parkingSlotService.countAvailableSlots()
        );
    }

    @GetMapping(
            "/available/vehicle-type/{vehicleTypeId}"
    )
    public ResponseEntity<List<ParkingSlot>>
